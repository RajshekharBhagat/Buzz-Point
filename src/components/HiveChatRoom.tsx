...
export default function HiveChatroom({hive}:{hive: Hive}) {
  ...
  return (
    <div className="flex flex-col h-full">
      <div className="flex items-center justify-between px-6 py-4 bg-white border-b border-gray-200 shadow-md shadow-black/20 rounded-xl my-4">
      ...
      <div className="bg-white border-t border-gray-200 p-2 rounded-xl shadow-lg shadow-black/20">
        <div className="flex items-center gap-3 max-w-4xl mx-auto">
          ...
          <button 
            ...
            type="button"
            title={!isConnected ? "Not connected" : input.trim() ? "Send message" : "Type a message"}
          >
            <SendHorizontalIcon />
          </button>
        </div>
